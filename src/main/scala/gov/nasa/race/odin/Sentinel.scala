...
/**
 * Sentinel and various related parsers and update events represent the data model for Delphire's powerline
 * fire sensors (see https://delphiretech.com/). This is an example of how to make external services available within
 * RACE to create OpenData Integration (ODIN) applications.
 *
